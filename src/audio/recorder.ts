 ...
 */
export function recordStream(): { stream: Readable; process: ChildProcess } {
  ...
  return { stream: proc.stdout as Readable, process: proc };
}
 ...
 */
export async function recordBuffer(durationMs: number): Promise<Buffer> {
