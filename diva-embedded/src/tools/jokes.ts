...
let db: JokesDB = { jokes: [], riddles: [], facts: [] };
const usedJokes = new Set<number>();
...
function pickRandom<T extends { id: number }>(items: T[], used: Set<number>): T | null {
...
export function getRandomJoke(category?: string): Joke | null {
...
export function getRandomRiddle(category?: string): Riddle | null {
...
export function getRandomFact(category?: string): Fact | null {
